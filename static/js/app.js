...
const PDFSelector = ({ pdfs, selectedPDF, onSelect }) => (
    <div className="mb-6 p-6 bg-white rounded-3xl shadow-lg chat-container">
        <label htmlFor="pdf-select" className="block text-lg font-medium text-primary mb-2">Select PDF to Query:</label>
        <select
            id="pdf-select"
            value={selectedPDF}
            onChange={(e) => onSelect(e.target.value)}
            className="bg-white text-gray-900 rounded-md px-4 py-2 w-full border border-gray-200 focus:border-[#4F6EF7] focus:ring focus:ring-[#4F6EF7] focus:ring-opacity-50"
        >
